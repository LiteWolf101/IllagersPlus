    ...
    public static void genCommandStructureFeatures(ICommandSender sender, String name, String rotation, World world, BlockPos pos, Random random){
        if (name.equals("illager_archer_tower")) {
            if (rotation.equals("rotateNone")) {
                setLoot(world, random, IllagerPlusLootTable.ILLAGER_ARCHER_TOWER, pos.add(7, 8, 5));
                spawnArcher(world, pos.add(4.5, 9, 4.5));
                spawnArcher(world, pos.add(4.5, 9, 8.5));
                spawnArcher(world, pos.add(8.5, 9, 8.5));
                spawnArcher(world, pos.add(8.5, 9, 4.5));
            } else if (rotation.equals("rotate90")) {
                setLoot(world, random, IllagerPlusLootTable.ILLAGER_ARCHER_TOWER, pos.add(-5, 8, 7));
                spawnArcher(world, pos.add(-4.5, 9, 4.5));
                spawnArcher(world, pos.add(-8.5, 9, 4.5));
                spawnArcher(world, pos.add(-8.5, 9, 8.5));
                spawnArcher(world, pos.add(-4.5, 9, 8.5));
            ...
            sender.sendMessage(new TextComponentString(TextFormatting.RED + "[ERROR:] " + name + " does not have any loot/entities."));
        }
    }
