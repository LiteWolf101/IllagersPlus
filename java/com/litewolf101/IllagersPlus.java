...
@Mod(
        modid = IllagersPlus.MOD_ID,
        name = IllagersPlus.MOD_NAME,
        version = IllagersPlus.VERSION,
        acceptedMinecraftVersions = IllagersPlus.ACCEPTED_MINECRAFT_VERSIONS,
        guiFactory = "com.litewolf101.utils.IllagersPlusGUIConfig"
)
public class IllagersPlus {
    ...
    /**
     * This is the first initialization event. Register tile entity here.
     * The registry events below will have fired prior to entry to this method.
     */
    @Mod.EventHandler
    public void preinit(FMLPreInitializationEvent event) {
        configDir = new File(event.getModConfigurationDirectory(), "illagers_plus");
    ...
    */
    ...
    public void serverLoad(FMLServerStartingEvent event) {
        event.registerServerCommand(new IllagersPlusCommands());
    }
}
