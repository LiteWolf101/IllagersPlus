...
import com.litewolf101.illagersplus.objects.entity.EntityFurantur;
...
@OnlyIn(Dist.CLIENT)
public class ModelFurantur extends EntityModel<EntityFurantur> implements IHasArm {
    ...
    public ModelFurantur(float scaleFactor, float p_i47227_2_, int textureWidthIn, int textureHeightIn) {
    ...
    @Override
    public void render(EntityFurantur entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
    ...
    @Override
    public void setRotationAngles(EntityFurantur entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
